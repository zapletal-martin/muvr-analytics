...
public final class Timeseries implements Iterable<TPoint>, Cloneable, Serializable {
     ...
     * @throws edu.hawaii.jmotif.timeseries.TSException if error occurs.
     */
     ...
     * @throws edu.hawaii.jmotif.timeseries.TSException if wrong position specified.
     */
    ...
    public Timeseries clone() throws CloneNotSupportedException {
        ...
        try {
            ...
            throw new CloneNotSupportedException("Exception thrown! ");
        }
    }
